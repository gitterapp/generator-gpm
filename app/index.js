...
module.exports = class extends Generator {
  ...
  initializing() {
    // Welcome
    this.log(yosay('Welcome to the gpm generator!'))
  }
  ...
  prompting() {
    ...
    const prompts = {
      ...
      askForType: () => {
        ...
        if (extensionType) {
          ...
          if (extensionTypes.indexOf(extensionType) !== -1) {
            generator.extensionConfig.type = `gpm-${extensionType}`
          } else {
            generator.log(
      ...
      askForProjectDesc: () => {
        ...
        return generator
          .prompt({
            ...
            default: 'A gpm project generated by see generator.',
          })
          .then(nameAnswer => {
      ...
      askForPackageManager: () => {
        if (['gpm-loader', 'gpm-plugin'].indexOf(generator.extensionConfig.type) === -1) {
          return Promise.resolve()
        }
  ...
  writing() {
    ...
    switch (this.extensionConfig.type) {
      case 'gpm-loader':
        this._writingGpmLoader()
        break
      case 'gpm-plugin':
        this._writingGpmPlugin()
        break
      default:
